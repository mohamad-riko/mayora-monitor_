...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="images/mayora-logo.png" />
</head>
<body>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <tbody>
                    <?php 
                    $no = 0;
                    $query = mysqli_query($koneksi, "SELECT * FROM tb_product");
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $product['qty-planing'];?></td>
                    <td><?php echo $product['qty-good'];?></td>
                    <td><?php echo $product['qty-reject'];?></td>
                </tr>
                  <?php }?>
                  </tbody>
                    </table>
